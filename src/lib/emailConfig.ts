...
export function notificationTypeToCategory(
  type: "tip" | "payout" | "payout_requested" | "payout_processing" | "payout_paid" | "payout_failed" | "verification_needed" | "theme_sold" | "theme_unlocked" | "creator_approved" | "security" | "support",
): EmailCategory {
  switch (type) {
    case "tip":
    case "payout":
